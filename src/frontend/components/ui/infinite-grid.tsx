...
/**
 * Lightweight background-only version to embed behind sections (no controls/content).
 */
export function InfiniteGridBackground({
  ...
  return (
    <div
      ref={containerRef}
      className={cn("absolute inset-0", interactive ? "pointer-events-none" : "pointer-events-none", className)}
    >
