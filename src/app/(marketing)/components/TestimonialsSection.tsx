    ...
    <section id="testimonials" className="py-20 bg-gradient-to-b from-background/95 to-background overflow-hidden">
      <div className="container px-4 mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-base sm:text-lg text-muted-foreground">Prism speeds up planning while keeping everything crystal clear. See what teams love.</p>
        </div>

        <div className="relative">
          <InfiniteMovingCards
            items={[
              { quote: "“We got everyone aligned in a single day instead of weeks.”", name: "Lan P.", title: "Head of Product" },
              { quote: "“Roadmaps finally match our team’s real capacity.”", name: "Khai N.", title: "Eng Manager" },
              { quote: "“Investor-ready exports that actually impress.”", name: "Minh T.", title: "Founder" },
            ]}
            direction="left"
            speed="slow"
            className="py-4"
