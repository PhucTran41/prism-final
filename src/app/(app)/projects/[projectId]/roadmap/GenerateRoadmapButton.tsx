...
export default function GenerateRoadmapButton({ projectId, projectName }: { projectId: string; projectName?: string }) {
  ...
  const submit = async () => {
    ...
    try {
      ...
      toast.success("Roadmap generated (review in list)", { id: toastId });
      setOpen(false);
      location.reload();
    } catch (e: any) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button disabled={loading} size="sm">Generate roadmap</Button>
      </DialogTrigger>
